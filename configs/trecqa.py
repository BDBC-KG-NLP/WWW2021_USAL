...
def parse_args(args):
    ...
    parser.add_argument('--name', type=str, default='trecqa', help="config name")
    parser.add_argument('--datapath', type=str, default='data/trecqa/trecqa.test.json',
    ...
    parser.add_argument('--dev_path', type=str,
                        default='data/trecqa/trecqa.dev.json', help='')
    parser.add_argument('--preds_path', type=str,
                        default='data/trecqa/use_preds.json')
