...
def parse_args(args):
    ...
    parser.add_argument('--name', type=str, default='semeval2016', help="model name")
    parser.add_argument('--datapath', type=str, default='data/semeval2016/semval2016.test.json',
    ...
    parser.add_argument('--neg_ratio', type=float, default=0.5, help="ratio of neg sample")
    ...
    parser.add_argument('--test_path', type=str, default='data/semeval2016/semval2016.test.json', help='')
    parser.add_argument('--train_path', type=str,
                        default='data/semeval2016/semval2016.train.json', help='')
    parser.add_argument('--dev_path', type=str,
                        default='data/semeval2016/semval2016.dev.json', help='')
    parser.add_argument('--preds_path', type=str,
                        default='data/semeval2016/use_preds.json')
