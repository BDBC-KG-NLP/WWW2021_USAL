...
def parse_args(args):
    ...
    parser.add_argument('--name', type=str, default='wikiqa', help="dataset name")
    parser.add_argument('--datapath', type=str, default='data/wikiqa/wikiqa.test.json',
    ...
    parser.add_argument('--dev_path', type=str,
                        default='data/wikiqa/wikiqa.dev.json', help='')
    parser.add_argument('--preds_path', type=str,
                        default='data/wikiqa/use_preds.json')
